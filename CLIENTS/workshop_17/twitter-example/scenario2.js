...
var tileBname = "Tile_33";
var tileCname = "Tile_5C";
...
client.on('receive', function(tileId, event) {
    ...
    //var tileB = reader.getTile(tileBname, client);
		var tileC = reader.getTile("Tile_5c", client);
    ...
    if (eventTile.name === tileC.name && eventTile.isSingleTap) {
